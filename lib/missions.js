...
export const TRACKS = [
    ...
    missions: [
      {
        ...
        fields: [
          ...
          { id: 'qtd_filhos', label: 'Quantos filhos?', type: 'number' },
        ],
      },
      {
        id: 'diag_inicial',
      ...
      },
      {
        ...
        desc: 'Cadastre suas dívidas: a parcela, o prazo e a taxa de juros de cada uma. Se preferir, consulte tudo no Registrato do Banco Central.',
        points: 120,
        type: 'dividas',
      },
    ],
  },
  {
    ...
    missions: [
      {
        id: 'orc_planejado',
        title: 'Orçamento planejado do mês',
        desc: 'No começo do mês: planeje quanto pretende ganhar e gastar em cada categoria.',
        points: 100,
        type: 'form',
        repeatable: true,
        fields: [
          { id: 'renda', label: 'Total que você planeja receber no mês (R$)', type: 'number' },
      ...
      {
        id: 'orc_realizado',
        title: 'Orçamento realizado do mês',
        desc: 'No fim do mês: informe o que de fato entrou e saiu. Assim você compara com o que planejou.',
        points: 100,
        type: 'form',
        repeatable: true,
        requires: 'orc_planejado',
        fields: [
          { id: 'renda', label: 'Total que realmente entrou no mês (R$)', type: 'number' },
          { id: 'moradia', label: 'Moradia — aluguel, prestação, condomínio (R$)', type: 'number' },
          { id: 'contas', label: 'Contas — água, luz, gás, internet (R$)', type: 'number' },
          { id: 'alimentacao', label: 'Alimentação (R$)', type: 'number' },
          { id: 'transporte', label: 'Transporte (R$)', type: 'number' },
  ...
  },
  {
    id: 'patrimonio',
    name: 'Patrimônio',
    intro: 'Patrimônio é tudo que é seu. Saber o tamanho dele muda o jogo.',
    missions: [
      {
        id: 'pat_bens',
        title: 'Cadastre seu patrimônio',
        desc: 'Liste o que você tem: imóvel, veículo, dinheiro guardado, investimentos. Se algo ainda está sendo pago, informe quanto falta.',
        points: 120,
        type: 'patrimonio',
      },
    ],
...
export const DEFAULT_MODULE_POINTS = {
  ...
  reserva: 150, objetivos: 120, habitos: 100, patrimonio: 130,
};
